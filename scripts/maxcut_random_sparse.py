...
if __name__ == "__main__":
    ...
    is_spin_glass = (sys.argv[4] not in ["0", "False"]) if len(sys.argv) > 4 else True
    ...
    print("(The sparsity is 50%, and the randomized and symmetric average nonzero weight is about 0.5, from the range 0.0 to 1.0.)")
