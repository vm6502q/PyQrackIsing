...
if __name__ == "__main__":
    ...
    quality = int(sys.argv[2]) if len(sys.argv) > 2 else 6
    ...
    best_circuit, best_path_length = tsp_symmetric(G, quality=quality, multi_start=multi_start, monte_carlo=False)
